...
function Home(props) { 
    ...
    return (
        <div>
            ...
            {props.pocket_token !== false && !props.isFetchingPocketDeveloper   ? window.location.replace(`https://getpocket.com/auth/authorize?request_token=${`${props.pocket_token}`.slice(5)}&redirect_uri=https://xenodochial-bardeen-1bef0f.netlify.com/profile`): console.log(`${props.pocket_token}`.slice(5))}
