...
const initialState = {
    ...
    isFetchingMercuryDataError: null,

    isPostingMercuryData: false,
    isPostingMercuryDataError: null,
...
export const serverReducer = (state = initialState, {type, payload}) => { 
    switch(type){
        case constants.GETTING_MERCURY_DATA:
            return {
                ...state, 
                isFetchingMercuryData: true
            }
        case constants.GOT_MERCURY_DATA:
            return {
                ...state, 
                MercuryData: payload
            }
